app.controller('payment_application', [ '$timeout', '$http', 'vcRecaptchaService', 'LanguageService', 'ValidationService', '$sce', function($scope, $timeout, $http, recaptcha, LanguageService,ValidationService,$sce){
